...
interface GibbstownProps {
  onNavigate: (page: string) => void;
}

export default function Gibbstown({ onNavigate }: GibbstownProps) {
  useEffect(() => {
    document.title = 'Lawn Care & Property Maintenance in Gibbstown, NJ | Brown\'s Lawn Care';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional lawn care and property maintenance in Gibbstown, NJ. Family-owned, reliable service for homes and businesses. Free quotes available.');
    }
  }, []);
  ...
  const qualifications = [
    'A dependable lawn care company in Gibbstown',
  ...
  const faqs = [
    {
      question: 'Do you offer weekly lawn mowing in Gibbstown?',
      answer: 'Yes, we provide reliable weekly lawn maintenance throughout Gibbstown. Our services include mowing, edging, trimming, and blowing for a clean, professional finish every visit.',
    },
    {
      question: 'Do you service both residential and commercial properties?',
      answer: 'Absolutely. We serve homeowners, HOAs, and businesses throughout Gibbstown and surrounding areas. Whether you need weekly mowing for your home or year-round property maintenance for your business, we have the experience and equipment to deliver consistent results.',
    },
    {
      question: 'How do I get a quote for lawn care in Gibbstown?',
    ...
    <div className="pt-20">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="max-w-4xl">
              <h1 className="font-heading font-bold text-4xl md:text-5xl lg:text-6xl leading-tight mb-6">
                Lawn & Property Maintenance in Gibbstown, NJ
              </h1>
              <p className="text-xl md:text-2xl mb-8 text-gray-100 leading-relaxed">
                Reliable, family-owned lawn care and property maintenance for homes, businesses, and HOAs in Gibbstown, NJ.
              </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-4">
              Based in nearby Mullica Hill, <strong>Brown's Lawn Care & Property Maintenance</strong> proudly serves homeowners, businesses, and HOAs throughout Gibbstown. We understand the expectations of Gibbstown properties — clean presentation, reliable scheduling, and consistent results.
            </p>
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              Our crews regularly work in Gibbstown, allowing us to provide consistent scheduling and dependable service year-round.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-heading font-bold text-3xl md:text-4xl text-dark mb-4">
              Lawn & Property Services We Offer in Gibbstown
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              In Gibbstown, our most requested lawn and property services include:
            </p>
          </div>
      ...
      <section className="py-16 bg-primary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-heading font-bold text-3xl md:text-4xl text-white mb-6">
            Looking for Reliable Lawn Care in Gibbstown?
          </h2>
          <button
            onClick={() => onNavigate('contact')}
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                While our home base is in Mullica Hill, we also serve nearby communities such as Gibbstown, Swedesboro, Paulsboro, and surrounding areas. Our crews regularly operate in this area, allowing for efficient scheduling and reliable service.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-heading font-bold text-3xl md:text-4xl text-dark mb-4">
              Lawn Care in Gibbstown — Common Questions
            </h2>
          </div>
